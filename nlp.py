...
def nc_from_word(sent, match_word):
    #print(str(sent), str(match_word))
...
def nerConnection():
    ...
    return StanfordNERTagger(
        join(env.homeDir, 'stanford-ner-2018-10-16/classifiers/english.all.3class.distsim.crf.ser.gz'),
